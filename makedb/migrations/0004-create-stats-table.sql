...
VALUES 
('buttons_pressed', 'Buttons Pressed', 'Total number of buttons that users have pressed', 0, 0, 1),
('pressed_last_day', 'Buttons pressed in the last day', 'Total number of buttons that users have pressed in the last 24 hours', 0, 0, 2),
